    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(max_length=500, verbose_name='Краткий текст поста')),
                ('text', models.TextField(verbose_name='Полный текст поста')),
                ('thumbnail', models.ImageField(blank=True, default='default.jpg', upload_to='images/thumbnails', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=('png', 'jpg', 'webp', 'jpeg', 'gif'))], verbose_name='Изображение')),
